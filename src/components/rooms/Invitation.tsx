  ...
  return (
    <div className="box-border flex bg-hero-rooms-2 h-auto ">
      <div className="box-border bg-black bg-opacity-20 h-auto pb-9  flex flex-col ">
        <div className=" xl:flex-col xl:h-screen xl:py-0 xl:px-32 md:px-12 box-border w-full flex flex-col h-auto py-9 px-2  justify-center items-center sm:gap-5 xl:gap-12 gap-20  text-white">
          <div className="flex flex-col items-center">
            ...
            <span className="md:px-0 sm:text-2xl text-basic text-center font-poppins  sm:px-12 px-6 w-7/12">
